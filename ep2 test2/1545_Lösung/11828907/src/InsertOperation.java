...
public class InsertOperation implements StringOperationSingle // TODO: uncomment clause.
{
    ...
    public Countable getCountable(StringOperationSingle search) {
        StringOperationSingle that = this;
        return new Countable() {
            @Override
            public int count() {
                return that.equals(search) ? 1 : 0;
            }
        };
    }
    ...
    public boolean equals(Object o) {
        ...
        return startIndex == that.startIndex && toInsert.equals(that.toInsert);
    }

    @Override
    public int hashCode() {
        return Objects.hash(toInsert, startIndex);
    }
}
